...
ALT(DEF_ASM_OP2(psrlq, 0x0f73, 2, OPC_MODRM, OPT_IM8, OPT_MMXSSE ))
    ...
    DEF_ASM_OP2(pxor, 0x0fef, 0, OPC_MODRM, OPT_EA | OPT_MMXSSE, OPT_MMXSSE )
     ...
     /* sse */
    /*DEF_ASM_VEX_OP1(ldmxcsr, 0xae, 2, OPC_VEX | OPC_MODRM, OPT_EA)*/
    /*DEF_ASM_VEX_OP1(stmxcsr, 0xae, 3, OPC_VEX | OPC_MODRM, OPT_EA)*/
    DEF_ASM_VEX_OP2(vmovups, 0x10, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )
ALT(DEF_ASM_VEX_OP2(vmovups, 0x11, 0, OPC_VEX | OPC_MODRM, OPT_SSE, OPT_EA | OPT_SSE ))
    DEF_ASM_VEX_OP2(vmovaps, 0x28, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )
ALT(DEF_ASM_VEX_OP2(vmovaps, 0x29, 0, OPC_VEX | OPC_MODRM, OPT_SSE, OPT_EA | OPT_SSE ))
    DEF_ASM_VEX_OP2(vmovhps, 0x16, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )
ALT(DEF_ASM_VEX_OP2(vmovhps, 0x17, 0, OPC_VEX | OPC_MODRM, OPT_SSE, OPT_EA | OPT_SSE ))
    DEF_ASM_VEX_OP2(vaddps, 0x58, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )
    DEF_ASM_VEX_OP2(vcvtpi2ps, 0x2a, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_MMX, OPT_SSE )
    DEF_ASM_VEX_OP2(vcvtps2pi, 0x2d, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_MMX )
    DEF_ASM_VEX_OP2(vcvtss2si, 0x2d, 0, OPC_VEX | OPC_MODRM | VEX_PP_F3, OPT_EA | OPT_SSE, OPT_REG32 )
ALT(DEF_ASM_VEX_OP2(vcvtss2si, 0x2d, 0, OPC_VEX | OPC_MODRM | VEX_PP_F3 | VEX_W, OPT_EA | OPT_SSE, OPT_REG64 ))
    DEF_ASM_VEX_OP2(vcvtsd2si, 0x2d, 0, OPC_VEX | OPC_MODRM | VEX_PP_F2, OPT_EA | OPT_SSE, OPT_REG32 )
ALT(DEF_ASM_VEX_OP2(vcvtsd2si, 0x2d, 0, OPC_VEX | OPC_MODRM | VEX_PP_F2 | VEX_W, OPT_EA | OPT_SSE, OPT_REG64 ))
    DEF_ASM_VEX_OP2(vcvttps2pi, 0x2c, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_MMX )
    DEF_ASM_VEX_OP2(vandps, 0x54, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )
    DEF_ASM_VEX_OP2(vdivps, 0x5e, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )
    DEF_ASM_VEX_OP2(vmaxps, 0x5f, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )
    DEF_ASM_VEX_OP2(vminps, 0x5d, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )
    DEF_ASM_VEX_OP2(vmulps, 0x59, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )
    DEF_ASM_VEX_OP2(vpavgb, 0xe0, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )
    DEF_ASM_VEX_OP2(vpavgw, 0xe3, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )
    DEF_ASM_VEX_OP2(vpmaxsw, 0xee, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_MMXSSE, OPT_MMXSSE )
    DEF_ASM_VEX_OP2(vpmaxub, 0xde, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_MMXSSE, OPT_MMXSSE )
    DEF_ASM_VEX_OP2(vpminsw, 0xea, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_MMXSSE, OPT_MMXSSE )
    DEF_ASM_VEX_OP2(vpminub, 0xda, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_MMXSSE, OPT_MMXSSE )
    DEF_ASM_VEX_OP2(vrcpss, 0x53, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )
    DEF_ASM_VEX_OP2(vrsqrtps, 0x52, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )
    DEF_ASM_VEX_OP2(vsqrtps, 0x51, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )
    DEF_ASM_VEX_OP2(vsqrtss, 0x51, 0, OPC_VEX | OPC_MODRM | VEX_PP_F3, OPT_EA | OPT_SSE, OPT_SSE )
    DEF_ASM_VEX_OP2(vsubps, 0x5c, 0, OPC_VEX | OPC_MODRM, OPT_EA | OPT_SSE, OPT_SSE )

    /* sse2 */
    DEF_ASM_VEX_OP2(vandpd, 0x54, 0, OPC_VEX | OPC_MODRM | VEX_PP_66, OPT_EA | OPT_SSE, OPT_SSE)
    DEF_ASM_VEX_OP2(vsqrtsd, 0x51, 0, OPC_VEX | OPC_MODRM | VEX_PP_F2, OPT_EA | OPT_SSE, OPT_SSE)

    /* avx */
    DEF_ASM_VEX_OP3(vpermilps, 0x04, 0, OPC_VEX | OPC_MODRM | VEX_PP_66 | VEX_MAP_0F3A, OPT_EA | OPT_SSE, OPT_SSE, OPT_IM8)
...
#undef DEF_ASM_OP2
#undef DEF_ASM_OP3
#undef DEF_ASM_VEX_OP0
#undef DEF_ASM_VEX_OP1
#undef DEF_ASM_VEX_OP2
#undef DEF_ASM_VEX_OP3
