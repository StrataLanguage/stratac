...
extern "C"
{
    ...
    StrataResult strataCompileString(StrataCompiler* c, const char* source, const char* moduleName, StrataEmitKind emit)
    {
        ...
        return CompileSource(c, source, strlen(source), moduleName ? moduleName : "strata_module", emit);
    }
    ...
    {
        StrataResult result = strataCompileFile(c, path, emit);
    ...
    static StrataJit* JitCompile(StrataCompiler* c, const char* source, size_t sourceLen, const char* moduleName,
                                 const char** errOut)
    {
        (void)c;
                                      ...
                                      const char** errOut)
    {
        ...
        return JitCompile(c, source, strlen(source), moduleName ? moduleName : "strata_module", errOut);
    }
